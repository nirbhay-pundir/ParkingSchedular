...
public class UserDashboardGUI extends javax.swing.JFrame {
    ...
    /**
     * <p>
     * Constructor for UserDashboardGUI.
     * </p>
     */
    ...
    private void payBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_payBtnMouseClicked
        ...
        String time = ParkingSchedular.date + " " + hh + ":" + arr[1] + ":" + arr[2].split(" ")[0];
        ParkingSchedular.server.releaseSlot(slotsMenu.getSelectedIndex(), userTable, time, chargeLabel.getText());
        intializeDetails();
    ...
    public void updateTotalCharge() {
        try {
            ...
            System.out.println(startDate + " " + ParkingSchedular.currentTime + " " + hours);
